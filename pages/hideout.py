...
# all crafts for each stations all levels query - query MyQuery {hideoutStations(gameMode: pve) { name crafts { duration requiredItems { item { name inspectImageLink} count } level rewardItems {item {name}}}imageLink}}
